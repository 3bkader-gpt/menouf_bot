...
|---------|--------|-------|
| `TELEGRAM_TOKEN` | `8411333724:AAFM9KDgEXmHxfvZ3K4wZlY3Zo3BU9v0544` | توكن البوت من @BotFather |
...
```
Key: TELEGRAM_TOKEN
Value: 8411333724:AAFM9KDgEXmHxfvZ3K4wZlY3Zo3BU9v0544
```
...
Value: (انسخ محتوى firebase-credentials.json كامل في سطر واحد)
```
...
```
✅ TELEGRAM_TOKEN = "8411333724:AAFM9KDgEXmHxfvZ3K4wZlY3Zo3BU9v0544"
✅ TELEGRAM_ADMIN_CHANNEL_ID = "-1003070315274"
✅ FIREBASE_SERVICE_ACCOUNT_JSON = "(انسخ من firebase-credentials.json في سطر واحد)"
